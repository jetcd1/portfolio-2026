    ...
    <main className="min-h-screen pt-32 pb-24">
      ...
      <section className="px-4 md:px-8 max-w-3xl mx-auto space-y-20">
        ...
        >
          ...
          <p className="text-lg text-muted leading-relaxed">
            At McKesson (Ontada), I focused on iKnowMed Generation 2, an intricate, ONC-certified oncology Electronic Health Record (EHR) system used by specialists nationwide. 
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <h2 className="text-3xl font-display font-medium mb-6">System Thinking applied to Healthcare</h2>
          <p className="text-lg text-muted leading-relaxed">
            The EHR space requires uncompromising precision and clarity. I helped establish scalable design system foundations that unified various disconnected tools into a single cohesive platform, greatly improving both designer and developer velocity while ensuring a safe, consistent experience for medical professionals.
          </p>
        </motion.div>
      </section>
      ...
      <section className="px-4 md:px-8 max-w-5xl mx-auto mt-32 text-center">
        ...
        <h2 className="text-5xl md:text-7xl font-display font-medium hover:text-accent transition-colors mb-12">
          <Link href="/work/equilar">Equilar Dashboards</Link>
        </h2>
